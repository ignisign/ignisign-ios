...
//  ExampleIgnisigniOS
//
//  Created by Marc Nigdélian on 21/12/2023.
//

import Foundation
import WebKit

struct IgnisignJSSignatureSessionsDisplayOptions {
    var showTitle: Bool
    var showDescription: Bool
    var darkMode: Bool = false
    var forceLanguage = "FR"//: IgnisignSignatureLanguages //todo test
    ...
    func convertToQueryString() -> String {
        let propertiesMap: [String: Any?] = [
            ...
            "darkMode": darkMode,
            "forceLanguage": forceLanguage,//.rawValue,
...
struct IgnisignSignatureSessionDimensions {
    var width: String
    var height: String
}

struct IgnisignInitParams {
...
class IgnisigniOS : WKWebView, WKScriptMessageHandler, WKNavigationDelegate {
    ...
    func initWebView(config: WKWebViewConfiguration) {
        ...
        /*load(URLRequest(url: URL(string: )*/
    }
    
    func setValues(appId: String, env: IgnisignApplicationEnv, ignisignClientSignUrl: String? = nil) {
        self.appId = appId
        self.env = env
    ...
    func initSignatureSession(initParams: IgnisignInitParams) {
